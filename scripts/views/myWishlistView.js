...
class MyWishlistView{
  ...
  async firstLoad() {
    ...
    Wish.readWishesOnWishlist(this.defaultWishlistId).then(wishes => {
      this.displayWishes(wishes, this.defaultWishlistId);
    });
  };
        ...
        <div id="${"wish-" + wish.id}" class="box">
          <div class="is-flex">
            ...
            <div class="ml-3">
              ...
              <div>
                <button id="${"wish-" + wish.id}" class="button go-to-wish-website">Go to shop</button>
              </div>
              <div>
                <button id="${"wish-" + wish.id}" class="button move-wish">Move to...</button>
                <button id="${"wish-" + wish.id}" class="button edit-wish">Edit</button>
                <button id="${"wish-" + wish.id}" class="button delete-wish">Delete</button>
              </div>
            </div>
